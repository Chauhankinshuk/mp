...
const Add = ({token}) => {
 ...
 const [subCategory,setSubCategory]=useState("tablets");
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      <div>
        ...
        <div className='flex gap-2'>
          <label htmlFor="image1">
            <img className='w-20' src={!image1 ? upload :URL.createObjectURL(image1)} alt='upload' />
            <input onChange={(e)=>setImage1(e.target.files[0])}  type='file' id='image1' hidden/>
          </label>
          <label htmlFor="image2">
            <img className='w-20' src={!image2 ? upload :URL.createObjectURL(image2)} alt='upload' />
            <input  onChange={(e)=>setImage2(e.target.files[0])} type='file' id='image2' hidden/>
          </label>
          <label htmlFor="image3">
            <img className='w-20' src={!image3 ? upload :URL.createObjectURL(image3)} alt='upload' />
            <input onChange={(e)=>setImage3(e.target.files[0])}  type='file' id='image3' hidden/>
          </label>
          <label htmlFor="image4">
            <img className='w-20' src={!image4 ? upload :URL.createObjectURL(image4)} alt='upload' />
      ...
      <div className='w-full'>
        ...
        <input  onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='TypeHere' required/>
      </div>
      <div className='w-full'>

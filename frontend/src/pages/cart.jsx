...
const Cart = () => {
  ...
  return (
    <div className='border-t pt-14 px-10 py-10'>
            ...
            return(
              <div key={index} className='flex justify-between py-4 border-t border-b text-gray-700 grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center  gap-4'>
                   <div className='flex items-start gap-6'>
                    <img className=' w-16 sm:w-20' src={productData.images[0]}></img>
                    <div>
                   ...
                   <FontAwesomeIcon onClick={()=>updateQuantity(item._id , item.size,0)} className='w-4 mr-4 sm:w-5 cursor-pointer' icon={faTrash}></FontAwesomeIcon>
              </div>
            )
          })
        }
